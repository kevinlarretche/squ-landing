        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { plan: "Pro", price: "$699", sub: "Level 03", bg: "INTEL", features: ["Up to 15 Products", "Everything in Growth", "Advanced Weekly Reports","Priority Support", "15,000 Monthly Scans"], col: "from-purple-500 to-indigo-400", active: true },
